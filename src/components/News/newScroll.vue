...
.sn-container .table .table-header {
  width: 100%;
  height: 35px;
  table-layout: fixed;
}

.sn-container .table .seamless-warp {
  height: 350px;
  overflow: hidden;
  visibility: visible;
}

.sn-container .table .seamless-warp .colorRed {
  color: #FF4669;
}

.sn-container .table .seamless-warp .colorOrange {
  color: #FFC956;
}

.sn-container .table .seamless-warp .item {
  height: auto;
  width: 100%;
  height: 35px;
  table-layout: fixed;
...
.sn-container .table .seamless-warp .item tr td.title {
