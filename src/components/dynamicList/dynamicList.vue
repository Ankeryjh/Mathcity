...
.container .pd-info-center {
  width: 100%;
  height: 100%;
}

.container .pd-info-center .y-center {
  position: absolute;
  top: 16px;
  left: 30px;
  width: 234px;
...
.container .pd-info-center .y-center>[class^='info-1'] {
  width: 100%;
  height: 100%;
  position: absolute;
  top: 0;
...
.container .pd-info-center .y-center .info-1-0 {
...
.container .pd-info-center .y-center .info-1-1 {
...
.container .pd-info-center .y-center .info-1-2 {
...
.container .pd-info-center .y-center .info-1-3 {
...
.container .pd-info-center .y-center .info-1-4 {
...
.container .pd-info-center .y-number {
  position: absolute;
  left: 0;
  padding-left: 290px;
...
.container .pd-info-center .y-number .y-number-bg {
  width: 54px;
  height: 54px;
  position: absolute;
  top: 5px;
...
.container .pd-info-center .y-number .y-number-icon {
  width: 54px;
  height: 54px;
  position: absolute;
  top: 5px;
...
.container .pd-info-center .y-number .y-number-text {
...
.y-number-text>span:nth-child(2) {
  font-size: 22px;
  color: #00aeef;
  line-height: 28px;
  padding: 0;
